...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Meja Baru</h1>
        <p class="text-gray-600">Masukkan informasi meja yang akan ditambahkan</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl shadow-lg p-6">
        <form method="POST" action="{{ route('admin.mejas.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50
                                {{ old('status_meja', 'tersedia') == 'tersedia' ? 'bg-blue-50 border-blue-500' : '' }}">
                                <input type="radio" name="status_meja" value="tersedia" 
                                    {{ old('status_meja', 'tersedia') == 'tersedia' ? 'checked' : '' }}
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                            ...
                            <label for="qr_code" class="cursor-pointer">
                                ...
                                <p class="text-sm text-gray-600">Upload QR Code (opsional)</p>
                                <p class="text-xs text-gray-400 mt-1">Format: JPEG, PNG, JPG (Max: 1MB)</p>
                                <p class="text-xs text-gray-500 mt-2">Akan di-generate otomatis jika tidak diupload</p>
                            </label>
                        </div>
                        @error('qr_code')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            placeholder="Masukkan deskripsi meja (opsional)">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700 mt-1">
                                    QR Code digunakan untuk sistem self-order pelanggan. 
                                    Pelanggan dapat scan QR Code untuk langsung memesan dari meja.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.mejas.index') }}" 
